          ...
          <Col xs="12" sm="8" lg="9" className="text-center mt-0 p-0">
            <ButtonDropdown className="mr-1 float-left ml-2" isOpen={this.state.dropdownOpen} toggle={this.toggle}>
              ...
              <DropdownMenu>
                ...
                <DropdownItem onClick={e=>this.onDeleteGuides(e, [checkedListAll])}><i className="fa fa-trash-o text-danger"></i>{t('pages.guide.operations.delete')}</DropdownItem>
